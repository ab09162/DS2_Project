...
public:
    ...
    bool searchProduct1(const std::string& category, const std::string& product);

    // Search for a product in using no category input.
    bool searchProduct2(const std::string& product);
